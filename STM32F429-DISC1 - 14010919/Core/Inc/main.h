...
//------------------------------
extern uint8_t pc_buf[228];
extern uint16_t pc_buf_size;
extern uint8_t num_packet;	
//------------------------------
/* USER CODE END EC */
...
#define LCD_GPIO0_Pin GPIO_PIN_2
#define LCD_GPIO0_GPIO_Port GPIOG
#define LCD_GPIO1_Pin GPIO_PIN_3
#define LCD_GPIO1_GPIO_Port GPIOG
...
/* USER CODE BEGIN Private defines */
	#define WAKEUP  0x02;						//WAKE UP MODE
	#define STANDBY 0x04;						//STANDBY MODE
	#define RESETC  0x06;						//RESET MODE
	#define START   0x08;						//START conversion
	#define STOP    0x0A;						//STOP conversion
	#define RDATAC  0x10;						//READ DATA CONTINUOUS MODE
	#define SDATAC  0x11;						//STOP DATA CONTINUOUS MODE
	#define RDATA   0x12;						//READ DATA BY COMMAND
	#define RREG    0x20;						//READ register
	#define WREG    0x40;						//write register
